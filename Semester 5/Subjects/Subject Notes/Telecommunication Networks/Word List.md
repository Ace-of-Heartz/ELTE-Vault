...
| broadcasting                           | adatszórás                     |
| packet fragmentation                   | csomag darabolás               |
| neighbor                               | szomszéd                       |
| next hop                               | következő ugrás                |
| cost                                   | költség                        |
| autonomous system                      | autonóm rendszer               |
| path vector                            | útvonal vektor                 |
| policy                                 | házirend                       |
| customer                               | ügyfél                         |
| source routing                         | forrás forgalomirányítás       |
| acknowledgement                        | nyugta                         |
| advertised window                      | meghírdetett ablak             |
| source spoofing                        | forrás hamisítás               |
| maximum segment size                   | maximális szegmens méret       |
| sliding window                         | csúszóablak                    |
| round-trip time                        | körülfordulási idő             |
| virtual private network (VPN)          | virtuális magánhálózat         |
| tunnel                                 | alagút                         |
| congestion                             | torlódás                       |
| buffer                                 | puffer                         |
| cliff                                  | szírt                          |
| knee                                   | könyök                         |
| congestion control                     | torlódás vezérlés              |
| congestion avoidance                   | torlódás elkerülés             |
| slow start                             | lassú indulás                  |
| fast retransmit                        | gyors újraküldés               |
| fast recovery                          | gyors helyreállítás            |
| cubic function                         | köbös függvény                 |
| explicit congestion notification (ECN) | explicit torlódás jelzés       |
| data center                            | adatközpont                    |
| query                                  | lekérdezés                     |
| domain name system (DNS)               | domén név rendszer             |
| zone file                              | zóna fájl                      |
| local                                  | helyi                          |
| server                                 | szerver                        |
| client                                 | kliens                         |
